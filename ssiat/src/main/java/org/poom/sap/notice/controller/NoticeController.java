...
public class NoticeController {
	...
	@RequestMapping(value="/noticeInsertForm.do", method=RequestMethod.GET)
	public String insertNoticeForm() {

		//return "redirect:notice/noticeInsert"; 는 안됨. 404. notice/notice/noticeInsert로 나옴
		//return "redirect:/noticeInsert";도 안됨. 404. /sap/notice/noticeInsert
		//return "redirect:/noticeInsert";도 안됨. 404. /sap/noticeInsert
		return "notice/noticeInsert";
	}
	
	
	
	@RequestMapping(value="/nInsert.do", method = {RequestMethod.GET, RequestMethod.POST})
...
//	}
	...
	@RequestMapping(value="/nInsert2.do", method = {RequestMethod.GET, RequestMethod.POST})
	...
	@RequestMapping(value="/nDetail.do", method = {RequestMethod.GET, RequestMethod.POST})
