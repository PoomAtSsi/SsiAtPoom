...
<body>
	...
	<hr>
	<a href="notice/nList.do">공지사항</a>
	<a href="#" onclick="location.href='notice/nList.do'">공지사항  location.href</a>
	
	<hr>
	<a href="notice/testMapArgumentResolver.do">notice/testMapArgumentResolver.do</a>
	
	<hr>
	<a href= "itcp/firstInterceptor.do" >인터셉터1</a>
