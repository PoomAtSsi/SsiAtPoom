...
<section class="container container-top container-center">
	<div class="vcenter-tb">
        ...
        <input type="text" class="form-control" name="id" id="id" autocomplete="off" placeholder="아이디를 입력하세요." value="" autofocus="autofocus"/>
       </div>
       ...
       <div class="form-group text-center">
       	<a href="#" class="point-color"><strong>회원가입</strong></a>
       </div>
      </form>
