...
<a href="noticeInsert.jsp" type="button">공지사항 등록</a>
...
<c:forEach items="${nlist }" var="n">
	...
	<tr><td>작 성 자</td>
	   <td><input type="text" readonly value="${ n.NOTICE_WRITER }"></td></tr>
	<tr><td>작성날짜</td>
	   <td><input type="text" readonly value="${ n.NOTICE_DATE }"></td></tr>
	<tr><td>조회수</td>
		<td><input type="text" readonly value="${ n.NOTICE_VIEWS }"></td></tr>
	<tr><td>공지글내용</td>
	   <td><textarea name="content" rows="7" cols="50">${ n.NOTICE_CONTENT }</textarea></td></tr>
