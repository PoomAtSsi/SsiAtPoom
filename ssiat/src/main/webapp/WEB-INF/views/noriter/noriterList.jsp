...
<body>
	<a href="noriterInsert.do" type="button">놀이터 등록</a> &nbsp;&nbsp;
	...
	<div>
		...
		<ul class="pagination">
			...
			<li><a aria-label="Previous"
				href="/sap/noriter/noriterList.do?page=1&category=${ category }"><span>«</span></a></li>
			...
			<li><a aria-label="Next"
				href="/sap/noriter/noriterList.do?page=${ totalPage }&category=${ category }"><span>»</span></a></li>
